...
public class rey : MonoBehaviour {
    ...
    void comer()
    {
        ...
        if (tag == "E1")
            GameObject.Find("ganador").GetComponent<Text>().text = "GANADOR E2";
        else
            GameObject.Find("ganador").GetComponent<Text>().text = "GANADOR E1";


        GameObject.Find("GameHandler").GetComponent<gamehandler>().fin_juego();
    ...
    void seleccionar()
    {
        ...
        newSelect.transform.position = transform.position + new Vector3(0, 7.0f, 0);
    }
}
