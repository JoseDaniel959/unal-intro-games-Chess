...
public class torre : MonoBehaviour {
    ...
    void comer()
    {
        ...
        if(GameObject.Find("GameHandler").GetComponent<gamehandler>().p_target.GetComponent<pieza>().pieza_n == 5 || GameObject.Find("GameHandler").GetComponent<gamehandler>().p_target.GetComponent<pieza>().pieza_n == 2)
        {
            if (GameObject.Find("GameHandler").GetComponent<gamehandler>().p_target.GetComponent<pieza>().pieza_n == 5)
            {
                GameObject.Find("GameHandler").GetComponent<gamehandler>().p_target.GetComponent<rey>().movio = true;
            }
            else
            {
                GameObject.Find("GameHandler").GetComponent<gamehandler>().p_target.GetComponent<torre>().movio = true;
            }
        }
    ...
    void seleccionar()
    {
        ...
        newSelect.transform.position = transform.position + new Vector3(0, 5.0f, 0);
    }
}
